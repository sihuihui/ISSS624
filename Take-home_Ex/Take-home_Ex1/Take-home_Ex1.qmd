...
WDMP <- tm_basemap(server = tiles)+ 
  ...
  tm_scale_bar() +
  tm_grid(alpha =0.2) +
  tm_credits("Source: Passenger trips data and BUs Stop Locations from LTA Datamall", 
...
tmap_arrange(WEMP, WEEP, ncol = 2)
```

:::{.callout-note appearance = "simple"}
## Observations 

-   Trips in Weekend Morning Peak hours seems to higher concentration 
